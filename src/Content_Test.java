...
public class Content_Test {
    ...
    public void testParseFile() throws IOException {
        ...
        // Parse the file
        Map<String, String> result = Content.parseFile(tempFile.getPath());
    ...
    public void testConvertMapToJson() {
        ...
        // Convert to JSON
        String json = Content.convertMapToJson(dataMap);
    ...
    public void testCreatePutRequest() {
        ...
        // Create PUT request
        String putRequest = Content.createPutRequest(jsonData);
    ...
    public void testSendPutRequest() throws IOException {
        ...
        assertEquals(2, Content.contentLamportClock);
    }
    ...
    public void testExtractLamportClock() {
        ...
        long lamportClock = Content.extractLamportClock(response);
